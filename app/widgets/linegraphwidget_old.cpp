...
// static limits
double LineGraphWidgetOld::maxVal = 90000.0;
double LineGraphWidgetOld::minVal = 300.0;

// declare meta type for usage in ReplotWorker
Q_DECLARE_METATYPE(Ui::LineGraphWidget *);

LineGraphWidgetOld::LineGraphWidgetOld(QWidget *parent, int nChannels) :
    QWidget(parent),
...
LineGraphWidgetOld::~LineGraphWidgetOld()
{
    if (worker != nullptr)
    {
        worker->deleteLater();
...
void LineGraphWidgetOld::setupGraph()
{
...
void LineGraphWidgetOld::setStartTimestamp(uint timestamp)
{
    startTimestamp = timestamp;
}

void LineGraphWidgetOld::setSensorFailureFlags(const std::vector<bool> flags)
{
...
QPair<double, double> LineGraphWidgetOld::getXRange()
{
    auto range = ui->chart->xAxis->range();
    return QPair<double, double>(range.lower, range.upper);
}

void LineGraphWidgetOld::setXRange(QPair<double, double> xRange)
{
...
void LineGraphWidgetOld::setLogXAxis(bool logOn)
{
    if (logOn)
    {
...
void LineGraphWidgetOld::setXRange(QCPRange range)
{
...
void LineGraphWidgetOld::resetColors()
{
...
void LineGraphWidgetOld::setNChannels(int value)
{
    // delete old graphs
...
int LineGraphWidgetOld::getNChannels() const
{
    return nChannels;
}

void LineGraphWidgetOld::resetGraph(int channels)
{
...
void LineGraphWidgetOld::setMaxVal(double val)
{
    maxVal = val;
}

void LineGraphWidgetOld::replot(uint timestamp)
{
    ...
    if (thread == nullptr)
    {
        ...
        connect(worker, &ReplotWorker::finished, this, &LineGraphWidgetOld::setYRange);
...
void LineGraphWidgetOld::setYRange(double y_lower, double y_upper)
{
    //set y-range
    graphMutex->lock();
...
void LineGraphWidgetOld::mousePressed(QMouseEvent * event)
{
...
void LineGraphWidgetOld::mouseMoved (QMouseEvent *  event)
{
...
void LineGraphWidgetOld::resizeEvent(QResizeEvent* event)
{
    coordText->position->setCoords(ui->chart->width()-60, ui->chart->height()-17);
}

void LineGraphWidgetOld::dataSelected()
{
...
void LineGraphWidgetOld::onXRangeChanged(QCPRange range)
{
    emit xRangeChanged(range);
}

void LineGraphWidgetOld::labelSelection(QMap<uint, MVector> selectionMap)
{
    // update class labels
...
void LineGraphWidgetOld::setIsAbsolute(bool value)
{
    isAbsolute = value;
...
bool LineGraphWidgetOld::saveImage(const QString &filename)
{
...
QPixmap LineGraphWidgetOld::getPixmap()
{
    return ui->chart->toPixmap();
}

void LineGraphWidgetOld::setReplotStatus(bool value)
{
...
void LineGraphWidgetOld::setSelection(QCPDataSelection newSelection)
{
...
bool LineGraphWidgetOld::getUseLimits() const
{
    return useLimits;
}

void LineGraphWidgetOld::setUseLimits(bool value)
{
    useLimits = value;
}

void LineGraphWidgetOld::clearGraph(bool replot)
{
    // signal changes
    emit selectionCleared();
...
void LineGraphWidgetOld::addMeasurement(MVector measurement, uint timestamp, std::vector<int> functionalisation, std::vector<bool> sensorFailures, bool rescale)
{
    Q_ASSERT(measurement.getSize() == nChannels);
...
void LineGraphWidgetOld::setData(QMap<uint, MVector> map, std::vector<int> functionalisation, std::vector<bool> sensorFailures)
{
    clearGraph(false);
...
void LineGraphWidgetOld::setAutoMoveGraph(bool value)
{
    autoMoveGraph = value;
}

void LineGraphWidgetOld::clearSelection()
{
    auto firstVisGraph = firstVisibleGraph();
    if (firstVisGraph == nullptr)
        return;
...
double LineGraphWidgetOld::getMinVal() const
{
    return minVal;
}

void LineGraphWidgetOld::setMinVal(double value)
{
    minVal = value;
}

double LineGraphWidgetOld::getMaxVal() const
{
    return maxVal;
}

std::array<uint, 2> LineGraphWidgetOld::getSelection()
{
 ...
 *
 */
void LineGraphWidgetOld::setLabel(int xpos, Annotation annotation, bool isUserAnnotation)
{
 ...
 * \param secondX
 */
void LineGraphWidgetOld::adjustLabelBorders(int firstX, int secondX)
{
...
void LineGraphWidgetOld::redrawLabels()
{
...
double LineGraphWidgetOld::getIndex(int key)
{
 ...
 * \return
 */
QPair<double, double> LineGraphWidgetOld::getLabelYCoords(bool isUserDefined)
{
    auto yRange = ui->chart->yAxis->range();
 ...
 * \return
 */
QCPGraph* LineGraphWidgetOld::firstVisibleGraph()
{
